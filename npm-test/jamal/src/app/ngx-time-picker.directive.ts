...
@Directive({
  selector: '[appNgxTimePicker]'
})

export class NgxTimePickerDirective implements OnInit {
  internalStyle;
  inlineStyleInfo;
  elementInfo: any = {
    input: null,
  ...
  runClock;
  clockValue;
  constructor(private el: ElementRef, private renderer: Renderer2, private clockService: ClockserviceService) { }
